...
if (ALIVE2_BUILD_DIR)
  ...
  find_library(ALIVE2_LLVM_UTIL_LIBS llvm_util PATHS "${ALIVE2_BUILD_DIR}" NO_DEFAULT_PATH)
  set(ALIVE_LIBS ${ALIVE2_IR_LIBS} ${ALIVE2_SMT_LIBS} ${ALIVE2_TOOLS_LIBS} ${ALIVE2_UTIL_LIBS} ${ALIVE2_LLVM_UTIL_LIBS})
